...
def team_colors(team_name)
  game_hash.each do |location, team_data|
    team_data.each do |team_attribute, data|
      if (team_attribute == :colors && game_hash[location][:team_name] == team_name)
        return data
      end
    end
  end
...
def player_numbers(team)
  ...
  game_hash.each do |location, team_data|
    team_data.each do |team_attribute, data|
      if (team_attribute == :players && team_data[:team_name] == team)
        data.each do |player, player_stats|
          player_stats.each do |stat_name, value|
            if stat_name == :number
  ...
  game_hash.each do |location, team_data|
    team_data.each do |team_attribute, data|
      if team_attribute == :players 
        data.each do |player, player_stats|
          player_stats.each do |stat_name, value|
            if stat_name == :shoe && value > biggest_shoe_size
